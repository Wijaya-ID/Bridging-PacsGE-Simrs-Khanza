...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private String alarm="",formalarm="",nol_detik,detik,tglsampel="",tglhasil="",norm="",kamar="",namakamar="",
            ...
            InformasiTambahan="",Klinis="",finger="",aktifjii="";
    ...
    private void initComponents() {
        ...
        BtnKirimDataJii = new widget.Button();
        BtnAmbilDataJii = new widget.Button();
        BtnLihatGambarJii = new widget.Button();
        BtnLihatGambarJiiAll = new widget.Button();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-06-2023 08:03:59" }));
        ...
        BtnKirimDataJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimDataJii.setText("Kirim Permintaan ke RIS JI'I");
        BtnKirimDataJii.setFocusPainted(false);
        BtnKirimDataJii.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimDataJii.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimDataJii.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimDataJii.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimDataJii.setName("BtnKirimDataJii"); // NOI18N
        BtnKirimDataJii.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnKirimDataJii.setRoundRect(false);
        BtnKirimDataJii.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimDataJiiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimDataJii);

        BtnAmbilDataJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAmbilDataJii.setText("Kirim Hasil ke RIS JI'I");
        BtnAmbilDataJii.setFocusPainted(false);
        BtnAmbilDataJii.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAmbilDataJii.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAmbilDataJii.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAmbilDataJii.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAmbilDataJii.setName("BtnAmbilDataJii"); // NOI18N
        BtnAmbilDataJii.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnAmbilDataJii.setRoundRect(false);
        BtnAmbilDataJii.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilDataJiiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAmbilDataJii);

        BtnLihatGambarJii.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLihatGambarJii.setText("Lihat Gambar ke RIS JI'I");
        BtnLihatGambarJii.setFocusPainted(false);
        BtnLihatGambarJii.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLihatGambarJii.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLihatGambarJii.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLihatGambarJii.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLihatGambarJii.setName("BtnLihatGambarJii"); // NOI18N
        BtnLihatGambarJii.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnLihatGambarJii.setRoundRect(false);
        BtnLihatGambarJii.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLihatGambarJiiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnLihatGambarJii);

        BtnLihatGambarJiiAll.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLihatGambarJiiAll.setText("Lihat Gambar ke RIS JI'I All");
        BtnLihatGambarJiiAll.setFocusPainted(false);
        BtnLihatGambarJiiAll.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLihatGambarJiiAll.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLihatGambarJiiAll.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLihatGambarJiiAll.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLihatGambarJiiAll.setName("BtnLihatGambarJiiAll"); // NOI18N
        BtnLihatGambarJiiAll.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnLihatGambarJiiAll.setRoundRect(false);
        BtnLihatGambarJiiAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLihatGambarJiiAllActionPerformed(evt);
            }
        });
        FormMenu.add(BtnLihatGambarJiiAll);
                ...
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    if(Sampel.equals("")||akses.getkode().equals("Admin Utama")){
                        if(Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_radiologi where stts_bayar='Sudah' and noorder=?",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString())>0){
                            ...
                            //custom
                          aktifjii = koneksiDB.AKTIFJII();
                            if(aktifjii.equals("yes")){
                                   jii.HapusRalan(NoPermintaan);
                            }
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnKirimDataJiiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimDataJiiActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnKirimDataJiiActionPerformed

    private void BtnAmbilDataJiiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataJiiActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnAmbilDataJiiActionPerformed

    private void BtnLihatGambarJiiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLihatGambarJiiActionPerformed
         if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnLihatGambarJiiActionPerformed

    private void BtnLihatGambarJiiAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLihatGambarJiiAllActionPerformed
       if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if(NoPermintaan.trim().equals("")){
                    ...
                    jii.GambarRalanAll(NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            }else{
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")){
                    ...
                    jii.GambarRanapAll(NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            }else{
    ...
    }//GEN-LAST:event_BtnLihatGambarJiiAllActionPerformed
    ...
    */
    ...
    private widget.Button BtnAmbilDataJii;
    ...
    private widget.Button BtnKirimDataJii;
    private widget.Button BtnLihatGambarJii;
    private widget.Button BtnLihatGambarJiiAll;
