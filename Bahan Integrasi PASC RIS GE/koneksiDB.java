...
public class koneksiDB {
    ...
    public static String URLCARESTREAM(){
     ...
     public static String AKTIFJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("AKTIFJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String IDJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("IDJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String URLJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String UNJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("UNJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PWJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("PWJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String URLHASILJII(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLHASILJII");
        }catch(Exception e){
            var=""; 
        }
        return var;
